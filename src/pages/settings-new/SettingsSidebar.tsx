...
export default function SettingsSidebar() {
    ...
    return (
        <div className={`relative hidden md:block md:w-1/5 min-h-screen h-full space-y-5  pt-32 md:pt-12 px-12 `}>
            ...
            <div className="space-y-7 md:space-y-3 pl-0 md:pl-5 text-sm">
                {[
                    { path: '/settings/my-account', label: 'My Account', icon: EditProfileIcon },
                    ...
                    { path: '/settings/help', label: 'Help & Support', icon: HelpSupportIcon },
                ].map((menu) => (
