...
import {
	useFollowProfileMutation, useGetConnectionsQuery, useUnFollowProfileMutation,
	useUpdateConnectionMutation
} from '../../api/connectionApi';
import EditProfile from '../../assets/edit_.svg';
import Location from '../../assets/location-tick.svg';
import Spinner from '../../components/Spinner';
import { toggleProfileFormModal, UpdateProfileFlowStages } from '../../state/slices/profileSlice';
    ...
    return (
        <>
            {header ? (
                <div className="!mr-0">
                    <button
                        className="edit-button flex-row centralize-y !h-max !p-3 centralize-x !mr-12 md:!mr-0"
                        onClick={onClick}
                        style={{
                            ...style,
                            cursor: 'pointer',
                    ...
                    >
                        <p className="whitespace-nowrap" id="edit-btn">
                            {text ?? 'Edit Profile'}
                        </p>
                ...
                <div>
                    ...
                    >
                        <button
                            className="flex-row centralize-y centralize-x  !h-max !p-3"
                            onClick={onClick}
                            style={{
                                ...style,
                                cursor: 'pointer',
        ...
        <>
            ...
            >
                {followIsLoading || unfollowIsLoading || updateConnectionIsLoading || unfollowConnectionIsLoading ? (
                    ...
                    <p className="w-max whitespace-nowrap" style={{ color: 'white', fontSize: '10px' }}>
                        {
                            {
