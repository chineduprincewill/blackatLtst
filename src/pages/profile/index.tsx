        ...
        <>
            <div className="profile-header" style={style}>
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <div className={`flex justify-center items-center border border-gray-400 rounded-full p-4 bg-[${getRandomHexColor()}] text-5xl md:text-8xl`} style={{ backgroundColor :getRandomHexColor() }}>
                        {generateProfileIcon((user.firstName+" "+user.lastName))}
                    </div>
            ...
            <div className="flex-column centralize-x">
                ...
                {showUpgrade && (
                    <Fragment>
                        ...
                        <div className="flex md:hidden px-4 py-8 justify-between items-center w-11/12 bg-[#ffeeb2] h-12 mt-4">
                            <button className='rounded-full px-4 py-2 text-sm bg-[#ffc700]' onClick={() => navigate('/user-type')}> Upgrade Account</button>
                            <p
                                className="dont-show !text-sm !underline"
                                style={{ cursor: 'pointer' }}
                                onClick={() => {
                                    setShowUpgrade(false);
                                    updateUser({
