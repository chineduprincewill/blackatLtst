...
export const WelcomeBack = () => {
    ...
    const initiateLogin = async () => {
        ...
        try {
            ...
            if ((error as any).data.message === 'Invalid credential combination' || (error as any).data.message === 'Oops User not found') {
            ...
            <div className="container min-w-[100vw]">
                ...
                <div className="content">
                    ...
                    <div className="form">
                        ...
                        <div id="forgot-password" className='w-full flex justify-between items-center'>
                            <Link to="/">
                        ...
                        <p className="!text-black don-t-have-an">
                            Don’t have an account?
                            <Link to="/create-acc" className="text-[#868686] underline">
                                {' '}
                                Create now
                            </Link>
                        </p>
