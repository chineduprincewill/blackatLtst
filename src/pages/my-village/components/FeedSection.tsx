...
import { useCreatePostForCommunityMutation, usePostOnCommunityFeedMutation } from 'api/communityApi';
import { useCreatePostMutation, useGetPostContentUploadLinkMutation, useViewPostQuery } from 'api/postApi';
...
import { FeedContainer, SmallIcon } from '@pages/feeds';
import { ParsePostPayload, PostPayload } from '@pages/feeds/components/FeedSection.utils';
import { IPostInputRef, PostInput } from '@pages/feeds/components/PostInput';
import { PromiseResult, SelectedContent } from '@pages/feeds/Feeds';
import { ImageCarousel } from '@pages/feeds/ImageCarousel';
import { Post, ReportPostDialog, RepostDialog } from '@pages/feeds/Post';
    ...
    const handleImageSelection = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        const contentPromises: Promise<PromiseResult>[] = Array.from(files).map((file): Promise<PromiseResult> => {
            ...
            if (contentType === 'video') {
                ...
                // TODO handle memory leaks from not removing event listeners
            } else {
