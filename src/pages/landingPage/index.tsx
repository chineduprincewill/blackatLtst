    ...
    return (
        ...
        >
            <div className="container">
                <div className="max-width ceontent flex-column centralize-x centralize-y !px-0 sm:!px-4">
                    <HeaderCenter mode={mode} setMode={setMode} pageToShow="home" />
                </div>
                <div className="max-width content flex-column centralize-x centralize-y !px-0 sm:!px-4">
                    ...
                    <div className="main max-width flex-row centralize-x">
                        <div className="top flex-column">
                            <div className="desc flex-row centralize-y">
                                ...
                                <div className="text-desc">
                                    <h3
                                        className="!text-2xl sm:!text-3xl lg:!text-5xl dakdo"
                                        style={{
                                    ...
                                    <div className="flex-row centralize-y">
                                        ...
                                        >
                                            <span className="black dakdo leading-[140%]">BLACK</span>
                                            {' EVERYWHERE'}
                                        </h3>
                                    </div>
                                </div>
                        ...
                        <div className="dive-area">
                            <p className="dive !text-[#C4C4C4] !leading-normal">
                            ...
                            <div className="continue w-full">
                                <button
                                    className="login-btn flex-row centralize-x centralize-y !w-full !max-w-[unset] gap-4 !py-4"
                                    onClick={() => navigate('/login')}
                                >
                                    <p className="!mr-0 md:mr-5">Log in</p>
                                    <img src={LongRight} alt="" className="!hidden xl:!block" />
                                </button>
                                <button
                                    className="started-btn !py-4 !w-full !max-w-[unset]"
