    ...
    return (
        <>
            <div className="sticky top-0 z-10">
                ...
                <div className="hidden md:flex justify-between items-center md:px-32 w-screen border-solid border-b border-b-[#CACACA] bg-white h-16">
                    ...
                    <div className="flex items-center justify-between md:w-3/9 h-full">
                        ...
                        >
                            <div className="flex items-center justify-center pl-4">
                                ...
                                />*/}
                                <div className={`flex max-w-max justify-center items-center border border-gray-400 rounded-full py-1 px-1.5 text-2xl`} style={{ backgroundColor : getRandomHexColor() }}>
                                    {generateProfileIcon((user.firstName+" "+user.lastName))}
                                </div>
                            </div>

                            <div className="">
                                <p className="text-sm sm:text-xs font-bold capitalize">
