    ...
    return (
        <div className={twMerge('relative w-full', props.className)}>
            <ClickOutsideWrapper onClickOutside={onClickOutSide}>
                <div role="button" onClick={() => setIsOpen((prev) => !prev)} className="relative z-50">
                    {React.isValidElement(props.children) ? (
                        ...
                        <button
                            type="button"
                            className="w-full p-4 text-sm font-medium text-left bg-white border border-solid rounded-md focus:outline-none hover:bg-gray-100 border-lightGray-6"
                        >
