...
export const authApiSlice = apiSlice.injectEndpoints({
    endpoints: (builder) => ({
        ...
        setPassword: builder.mutation<SetPasswordResponse, { email: string; password: string; passwordToken: string }>({
        ...
        resetPassword: builder.mutation<ResetPasswordResponse, { email: string; newPassword: string; passwordToken: string }>({
        ...
        getUsernameSuggestion: builder.mutation<GetUsernameSuggestionResponse, { email: string; firstName: string; lastName: string }>({
